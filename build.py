...
# Canonical BibTeX: the OpenReview export verbatim, with the citation key kept as
# `cooper2025books` so existing .tex files that already cite the preprint keep resolving.
BIBTEX = """@inproceedings{
cooper2025books,
title={Extracting memorized pieces of (copyrighted) books from open-weight language models},
author={A. Feder Cooper and Mark Lemley and Allison Casasola and Ahmed M Ahmed and Aaron Gokaslan and Amy B. Cyphert and Christopher De Sa and Daniel E. Ho and Percy Liang},
booktitle={Third Conference on Language Modeling},
year={2026},
url={https://openreview.net/forum?id=VE3f9mjaCd}
}"""
